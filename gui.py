...
layout = [[sg.Text('Caches:', size=(30,1),pad=(500,0))],
          ...
          [sg.Text('[0, I, 0, 0]', size=(30,1),pad=(55,0),key='C1V0'),
          sg.Text('[0, I, 0, 0]', size=(30,1),pad=(14,0),key='C2V0'),
          sg.Text('[0, I, 0, 0]', size=(30,1),pad=(7,0),key='C3V0'),
          sg.Text('[0, I, 0, 0]', size=(30,1),pad=(10,0),key='C4V0')],
          [sg.Text('[1, I, 0, 0]', size=(30,1),pad=(55,0),key='C1V1'),
          sg.Text('[1, I, 0, 0]', size=(30,1),pad=(14,0),key='C2V1'),
          sg.Text('[1, I, 0, 0]', size=(30,1),pad=(7,0),key='C3V1'),
          sg.Text('[1, I, 0, 0]', size=(30,1),pad=(10,0),key='C4V1')],

          [[sg.Text('L2 Cache:', size=(30,1),pad=(500,0))]],
          [sg.Text('[0, DI, 0, 0]', size=(30,1),pad=(500,0),key='L2V0')],
          [sg.Text('[1, DI, 0, 0]', size=(30,1),pad=(500,0),key='L2V1')],
          [sg.Text('[2, DI, 0, 0]', size=(30,1),pad=(500,0),key='L2V2')],
          [sg.Text('[3, DI, 0, 0]', size=(30,1),pad=(500,0),key='L2V3')],
